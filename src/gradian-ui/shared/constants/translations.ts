...
export const TRANSLATIONS: TranslationEntry[] = [
  ...
  { key: TRANSLATION_KEYS.WELCOME_BACK_TITLE, translations: [{ en: 'Welcome back, dear {name}' }, { fa: 'خوش آمدید، عزیز {name}' }, { ar: 'مرحباً بعودتك، عزيزي {name}' }, { es: 'Bienvenido de nuevo, querido/a {name}' }, { fr: 'Bon retour, cher/chère {name}' }, { de: 'Willkommen zurück, liebe/r {name}' }, { it: 'Bentornato, caro/a {name}' }, { ru: 'С возвращением, уважаемый/ая {name}' }] },
