...
export const TRANSLATIONS: TranslationEntry[] = [
  ...
  { key: TRANSLATION_KEYS.MESSAGE_SELECT_COLUMNS_FROM_LEFT_GROUP, translations: [{ en: 'Select columns from the left.' }, { fa: 'ستون‌ها را از سمت چپ انتخاب کنید.' }, { ar: 'حدد الأعمدة من اليسار.' }, { es: 'Selecciona columnas de la izquierda.' }, { fr: 'Sélectionnez les colonnes à gauche.' }, { de: 'Spalten links auswählen.' }, { it: 'Seleziona le colonne a sinistra.' }, { ru: 'Выберите столбцы слева.' }] },
