...
const gradientClasses: Record<string, string> = {
  ...
  // Purples
  violet: 'from-violet-200/90 via-purple-100/85 to-indigo-100/85 dark:from-violet-950/30 dark:via-purple-950/30 dark:to-indigo-950/30 border-violet-200 dark:border-violet-400',
...
export const WelcomeCard: React.FC<WelcomeCardProps> = ({
  ...
  const borderClass = gradientClass.split(' ').find(cls => cls.startsWith('border-')) || 'border-violet-200 dark:border-violet-400';
