...
export interface FormField {
  ...
  component: 'text' | 'search-input' | 'email' | 'tel' | 'number' | 'password' | 'url' | 'textarea' | 'json' | 'select' | 'multi-select' | 'checkbox' | 'checkbox-list' | 'radio' | 'date' | 'datetime-local' | 'datetime' | 'file' | 'picker' | 'popup-picker' | 'icon' | 'image-text' | 'image-viewer' | 'name' | 'avatar' | 'color-picker' | 'rating' | 'badge' | 'countdown' | 'code-viewer' | 'list-input' | 'sortable-selector' | 'tag-input' | 'toggle' | 'toggle-group' | 'switch' | 'signature-pad' | 'formula' | 'checklist' | 'swipe-button';
