...
export const GS1_AI_DICTIONARY: GS1AIDictionaryEntry[] = [
  { id: "00", name: "SSCC", label: { en: "SSCC", fa: "کد واحد حمل سریال" }, format: "string" },
  { id: "01", name: "GTIN", label: { en: "GTIN", fa: "شماره کالای جهانی" }, format: "string" },
  { id: "02", name: "CONTENT", label: { en: "GTIN of Contained Items", fa: "GTIN اقلام محتوا" }, format: "string" },
  ...
  { id: "400", name: "ORDER_NUMBER", label: { en: "Order Number", fa: "شماره سفارش" }, format: "string" },
  { id: "401", name: "GINC", label: { en: "GINC", fa: "شناسه محموله جهانی" }, format: "string" },
  { id: "402", name: "GSIN", label: { en: "GSIN", fa: "شناسه ارسال جهانی" }, format: "string" },
  { id: "403", name: "ROUTE", label: { en: "Routing Code", fa: "کد مسیریابی" }, format: "string" },
  ...
  { id: "240", name: "ADDITIONAL_ID", label: { en: "Additional ID", fa: "شناسه اضافی" }, format: "string" },
  { id: "241", name: "CUST_PART_NO", label: { en: "Customer Part Number", fa: "شماره قطعه مشتری" }, format: "string" },
  { id: "242", name: "MTO_VARIANT", label: { en: "MTO Variant", fa: "گونه سفارشی" }, format: "string" },
  { id: "243", name: "PCN", label: { en: "Packaging Component Number", fa: "شماره جزء بسته‌بندی" }, format: "string" },
  ...
  { id: "3900", name: "AMOUNT", label: { en: "Amount", fa: "مبلغ" }, format: "numeric" },
  { id: "3901", name: "AMOUNT", label: { en: "Amount", fa: "مبلغ" }, format: "numeric" },
  { id: "3902", name: "AMOUNT", label: { en: "Amount", fa: "مبلغ" }, format: "numeric" },
  { id: "3903", name: "AMOUNT", label: { en: "Amount", fa: "مبلغ" }, format: "numeric" },
  { id: "3910", name: "AMOUNT", label: { en: "Amount (with currency)", fa: "مبلغ (با واحد پول)" }, format: "numeric" },
  { id: "3911", name: "AMOUNT", label: { en: "Amount (with currency)", fa: "مبلغ (با واحد پول)" }, format: "numeric" },
  { id: "3912", name: "AMOUNT", label: { en: "Amount (with currency)", fa: "مبلغ (با واحد پول)" }, format: "numeric" },
  { id: "3913", name: "AMOUNT", label: { en: "Amount (with currency)", fa: "مبلغ (با واحد پول)" }, format: "numeric" },
  { id: "3920", name: "PRICE", label: { en: "Price", fa: "قیمت" }, format: "numeric" },
  { id: "3921", name: "PRICE", label: { en: "Price", fa: "قیمت" }, format: "numeric" },
  { id: "3922", name: "PRICE", label: { en: "Price", fa: "قیمت" }, format: "numeric" },
  { id: "3923", name: "PRICE", label: { en: "Price", fa: "قیمت" }, format: "numeric" },
  { id: "3930", name: "PRICE", label: { en: "Price (with currency)", fa: "قیمت (با واحد پول)" }, format: "numeric" },
  { id: "3931", name: "PRICE", label: { en: "Price (with currency)", fa: "قیمت (با واحد پول)" }, format: "numeric" },
  { id: "3932", name: "PRICE", label: { en: "Price (with currency)", fa: "قیمت (با واحد پول)" }, format: "numeric" },
  { id: "3933", name: "PRICE", label: { en: "Price (with currency)", fa: "قیمت (با واحد پول)" }, format: "numeric" },
  { id: "7001", name: "NSN", label: { en: "NSN", fa: "شماره ذخیره ناتو" }, format: "string" },
  ...
  { id: "7004", name: "ACTIVE_POTENCY", label: { en: "Active Potency", fa: "قدرت فعال" }, format: "string" },
  { id: "710", name: "NHRN_PZN", label: { en: "NHRN PZN", fa: "شماره بازپرداخت بهداشتی (آلمان)" }, format: "string" },
  { id: "711", name: "NHRN_CIP", label: { en: "NHRN CIP", fa: "شماره بازپرداخت بهداشتی (فرانسه)" }, format: "string" },
  { id: "712", name: "NHRN_CN", label: { en: "NHRN CN", fa: "شماره بازپرداخت بهداشتی (اسپانیا)" }, format: "string" },
  { id: "713", name: "NHRN_DRN", label: { en: "NHRN DRN", fa: "شماره بازپرداخت بهداشتی (برزیل)" }, format: "string" },
  { id: "8001", name: "DIMENSIONS", label: { en: "Dimensions", fa: "ابعاد" }, format: "string" },
  { id: "8002", name: "CMT_NO", label: { en: "CMT Number", fa: "شماره تلفن همراه" }, format: "string" },
  { id: "8003", name: "GRAI", label: { en: "GRAI", fa: "شناسه دارایی برگشت‌پذیر" }, format: "string" },
  { id: "8004", name: "GIAI", label: { en: "GIAI", fa: "شناسه دارایی منفرد" }, format: "string" },
  { id: "8005", name: "PRICE_PER_UNIT", label: { en: "Price Per Unit", fa: "قیمت هر واحد" }, format: "numeric" },
  { id: "8006", name: "GCTIN", label: { en: "GCTIN", fa: "اجزای کالا" }, format: "string" },
  { id: "8007", name: "IBAN", label: { en: "IBAN", fa: "شماره حساب بانکی بین‌المللی" }, format: "string" },
  { id: "8008", name: "PROD_TIME", label: { en: "Production Date and Time", fa: "تاریخ و زمان تولید" }, format: "string" },
  { id: "8010", name: "CPID", label: { en: "CPID", fa: "شناسه قطعه/جزء" }, format: "string" },
  { id: "8011", name: "CPID_SERIAL", label: { en: "CPID Serial", fa: "سریال CPID" }, format: "string" },
  { id: "8017", name: "GSRN_PROVIDER", label: { en: "GSRN Provider", fa: "ارائه‌دهنده GSRN" }, format: "string" },
  { id: "8018", name: "GSRN_RECIPIENT", label: { en: "GSRN Recipient", fa: "دریافت‌کننده GSRN" }, format: "string" },
  { id: "8019", name: "SRIN", label: { en: "SRIN", fa: "شماره نمونه رابطه خدمات" }, format: "string" },
  { id: "8020", name: "REF_NO", label: { en: "Reference Number", fa: "شماره مرجع" }, format: "string" },
  { id: "8200", name: "PRODUCT_URL", label: { en: "Product URL", fa: "آدرس محصول" }, format: "string" },
  { id: "90", name: "INTERNAL", label: { en: "Internal", fa: "داخلی" }, format: "string" },
  { id: "91", name: "INTERNAL", label: { en: "Internal", fa: "داخلی" }, format: "string" },
  { id: "92", name: "INTERNAL", label: { en: "Internal", fa: "داخلی" }, format: "string" },
  { id: "93", name: "INTERNAL", label: { en: "Internal", fa: "داخلی" }, format: "string" },
  { id: "94", name: "INTERNAL", label: { en: "Internal", fa: "داخلی" }, format: "string" },
  { id: "95", name: "INTERNAL", label: { en: "Internal", fa: "داخلی" }, format: "string" },
  { id: "96", name: "INTERNAL", label: { en: "Internal", fa: "داخلی" }, format: "string" },
  { id: "97", name: "INTERNAL", label: { en: "Internal", fa: "داخلی" }, format: "string" },
  { id: "98", name: "INTERNAL", label: { en: "Internal", fa: "داخلی" }, format: "string" },
  { id: "99", name: "INTERNAL", label: { en: "Internal", fa: "داخلی" }, format: "string" },
];
