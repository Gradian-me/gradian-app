    ...
    >
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DialogContent className="w-full max-w-xl p-0 overflow-hidden border-0 shadow-2xl">
          ...
          <div className="relative overflow-hidden rounded-2xl bg-linear-to-br from-violet-50 via-purple-50 to-indigo-50 dark:from-violet-950/30 dark:via-purple-950/30 dark:to-indigo-950/30 border border-violet-200 dark:border-violet-400">
