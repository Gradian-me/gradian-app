...
export function NestedTableRenderer({ data, schemas, showFlattenSwitch, flatten, onFlattenChange, highlightQuery, expandAllTrigger, onExpandAllReady, showIds }: NestedTableRendererProps) {
