...
export default function EmailTemplateBuilderPage() {
  ...
  useSetLayoutProps(
    !mounted ? {} : !ENABLE_BUILDER
      ? { title: 'Access Denied', subtitle: 'The builder is disabled in this environment.', icon: 'OctagonMinus' }
      : isLoading
        ? { title: 'Email Template Generator', subtitle: 'Design, personalize, and preview transactional Gradian.me emails', icon: 'Mail' }
        : { title: 'Email Template Generator', subtitle: 'Design, personalize, and preview transactional Gradian.me emails', icon: 'Mail' }
  );
