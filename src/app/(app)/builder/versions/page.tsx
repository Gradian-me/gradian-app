...
export default function VersionsPage() {
  ...
  useSetLayoutProps(
    !mounted ? {} : !ENABLE_BUILDER ? { title: 'Access Denied', subtitle: 'The builder is disabled in this environment.', icon: 'OctagonMinus' } : { title: 'App Versions', icon: 'GitBranch', subtitle: (<span className="flex items-center gap-1"><span className="font-medium text-gray-800 dark:text-gray-100">Track and manage application versions</span><span className="hidden text-gray-500 dark:text-gray-400 sm:inline">— view changes, priorities, and affected domains.</span></span>) }
  );
