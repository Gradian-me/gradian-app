...
export default function RelationTypesBuilderPage() {
  ...
  const layoutProps = !mounted ? {} : !ENABLE_BUILDER
    ...
    : { title: 'Relation Types', subtitle: loading || !schema ? 'Define and manage relationships between entities' : 'Define and manage relationships between entities in your application', icon: 'Link2' as const };
