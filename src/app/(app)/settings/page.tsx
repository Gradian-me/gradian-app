...
export default function SettingsPage() {
  ...
  useSetLayoutProps({ title: 'Settings' });
                  ...
                  {tabs.map((tab) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-center space-x-3 px-4 py-3 text-start hover:bg-gray-100 transition-colors first:rounded-t-xl last:rounded-b-xl ${
              ...
              <Card>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-4 ps-4 border-s-2 border-violet-200 dark:border-violet-800 mt-4">
                       <Switch
                         config={{
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-4 ps-4 border-s-2 border-violet-200 dark:border-violet-800mt-4">
                       <Switch
                         config={{
                           name: 'tenderUpdates',
