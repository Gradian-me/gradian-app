  ...
  try {
    ...
    if (schemaId === 'companies') {
      try {
        ...
        // If cache or param parsing fails, fall through to normal controller
        console.warn('Companies cache load failed or filter parsing failed, using controller:', error);
      }
    }
