...
export function AiBuilderWrapper({
  ...
  const handleGenerate = useCallback(() => {
    ...
    // Ensure imageType is always included in body if it exists in formValues and is not "none"
    // This handles cases where imageType might not be in the agent's renderComponents
    const imageType = formValues.imageType;
  ...
  }, [selectedAgentId, userPrompt, generateResponse, selectedAgent, formValues, scrollToLoadingIndicator]);
