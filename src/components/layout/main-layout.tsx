      ...
      <div className="flex flex-col min-w-0 flex-1">
        ...
        {subtitle && (
          <motion.div
            ...
            className="text-sm direction-auto text-start text-violet-600 dark:text-violet-400 mt-0.5 truncate min-w-0 leading-relaxed"
          >
            {subtitle}
          </motion.div>
        )}
  ...
  return (
    ...
    >
      ...
      >
        ...
        {showActionButtons && (
          <div className="sticky top-0 z-20 bg-gray-200/70 dark:bg-gray-900/80 backdrop-blur-sm border-b border-gray-200 dark:border-gray-700 px-4 py-1.5">
            <PageActionButtons />
          </div>
        )}
